...
export const handlePrompt: Provider['handlePrompt'] = async (
    payload,
    signal?: AbortSignal,
) => {
...
export const handleRapidPrompt: Provider['handleRapidPrompt'] = async (
    prompt,
    globalSettings,
) => {
...
const handleChatCompletion = async (
    ...
    const isStream = response.headers.get('content-type')
